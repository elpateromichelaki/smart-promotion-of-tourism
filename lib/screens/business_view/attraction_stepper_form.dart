...
class AttrStepperForm extends StatefulWidget {
  @override
  _AttrStepperFormState createState() => _AttrStepperFormState();
}

class _AttrStepperFormState extends State<AttrStepperForm> {
  ...
  saveBusiness(context) async{
    ...
    BusinessAttraction busAttr = BusinessAttraction(
        position: point.data,
        longitude: long,
        latitude: lat,
    ...
    try {
      await _business.doc().set(busAttr.toMap());
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Text("Type: Travel & Tourism"),
            ),
            Text("Name: "+_name),
            Padding(
              padding: const EdgeInsets.all(8.0),
            ...
            Text("Number of rooms: " +_visitTime.toString()),
            Text("Average Price: " +_entryFee.toString()),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Travel & Tourism Form'),
      ),
    ...
    return Column(
      children: <Widget>[
        ...
        Row(
          ...
          children: [
            DropdownButton(
              items: _attrType.map((value) => DropdownMenuItem(
                child: Text(value),
                value: value,
              )).toList(),
              onChanged: (val){
    ...
    return Column(
      children: <Widget>[
        Padding(
          ...
          child: Text(
            'Average time of visit in hours',
          ),
        ),
        TextField(
          inputFormatters: [
