...
import 'package:smart_promotion_of_tourism/models/business_simple.dart';
...
class SimpleStepperForm extends StatefulWidget{
  final String otherField;
  SimpleStepperForm({this.otherField});
  @override
  _SimpleStepperFormState createState() => _SimpleStepperFormState();
}

class _SimpleStepperFormState extends State<SimpleStepperForm> {
  ...
  Widget build(BuildContext context) {
    String other = widget.otherField;
  ...
  saveBusiness(context, String other) async{
    GeoFirePoint point = geofire.point(latitude: lat, longitude: long);
    BusinessSimple busSimple = BusinessSimple(
        position: point.data,
        longitude: long,
        latitude: lat,
    ...
    try {
      await _business.doc().set(busSimple.toMap());
